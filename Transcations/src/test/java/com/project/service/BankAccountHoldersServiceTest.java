...
public class BankAccountHoldersServiceTest {
	...
	public void getAccountHolderTest() {
		Mockito.when(repo.findByNamesAndLastName("Jordan Dale", "Bishop", "608 HIGH STREET, STOKE-ON-TRENT, ST6 5PD"))
				.thenReturn(Account_Holder1);
		assertEquals(Account_Holder1, service.getBankHolder(Account_Holder1));
		Mockito.verify(repo).findByNamesAndLastName("Jordan Dale", "Bishop",
				"608 HIGH STREET, STOKE-ON-TRENT, ST6 5PD");
	}
}
