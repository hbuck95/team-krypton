...
export default class Footer extends Component {
    ...
    render() {
        ...
        return (
            <div id="Footer" className="rounded-top" onMouseOver={this.handleHover} onMouseOut={this.handleHoverLeave} onMouseDown={this.handleClick} style={{ margin: "auto", position: "fixed", left: 0, bottom: 0, backgroundColor: "#474c55", height: "5%", width: "100%", textAlign: "center", color: "white" }} >
                <p style={{marginTop:20}} id="helpHeader">help me</p>
